    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          sellingPrice: vehicle.sellingPrice || vehicle.price || 0,
          status: vehicle.status || 'for_sale',
          isFeatured: vehicle.isFeatured || false,
          availableForRent: vehicle.availableForRent || false,
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Choose the type of vehicle</p>
              </div>
